    ...
    <div style={styles.authSplitPage}>
      ...
      <div className="auth-split-left" style={styles.leftPanel}>
        ...
        <div className="auth-left-content" style={styles.leftCenter}>
          <h2 style={styles.leftTitle}>Build your professional pathway.</h2>
          <p style={styles.leftSubtitle}>
            Create your profile in minutes, filter verified positions, and submit structured applications directly to recruiter matching systems.
          </p>

          <div className="glass-quote-card">
            <p style={styles.quoteText}>
              "The structured registration and profile details help candidate applications bypass messy keyword parsing completely. Recruiters see exact match compatibility scores immediately."
            </p>
            <div style={styles.quoteAuthor}>
              <div style={styles.authorAvatarSquare}>JN</div>
              <div>
                <p style={{ margin: "0 0 2px 0", fontSize: "13px", fontWeight: "700", color: "#FFFFFF" }}>Marcus Vance</p>
                <p style={{ margin: "0", fontSize: "11px", color: "#CBD5E1" }}>Head of Talent, Stripe</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="auth-split-right" style={styles.rightPanel}>
        <div style={styles.authFormContainer} className="auth-form-container">
          ...
          <div style={styles.formHeader}>
            ...
            <p style={styles.formSubtitle}>Join thousands of professionals and recruiters on JobNest</p>
          </div>
          ...
          <div style={styles.formFooter}>
            ...
            <button onClick={() => navigate("/login")} className="auth-nav-link">
